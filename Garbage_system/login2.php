<?php 
    ...
    $err='';
    if(isset($_POST['btn1'])){
        $sql = 'SELECT * FROM address2 WHERE name_disposal="'.$_POST['name_disposal'].'" AND password = "'.md5($_POST['password']).'"';
    ...
    <div class="form-box login">
        ...
        <form method="POST" action="#">
            ...
            <div class="login-register">
                <p>ยังไม่ลงทะเบียนใช่ไหม?<a href="register2.php" class="register-link" >  ลงทะเบียน</a></p>
            </div>
            <?php echo $err; ?>
        </form>
    </div>
